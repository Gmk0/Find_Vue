...
<template>
    <div v-show="LayoutStore.RightSidebarExpanded" @keydown.window.escape="LayoutStore.tooglePanelFalse()">
        <div @click="LayoutStore.tooglePanelFalse()" v-if="LayoutStore.RightSidebarExpanded">

            <transition enter-class="ease-out" enter-to-class="opacity-100" enter-active-class="opacity-100"
                leave-class="ease-in" leave-active-class="opacity-100" leave-to-class="opacity-0">
        ...
        <div class="fixed right-0 top-0 z-[151] h-full w-full sm:w-80">
            <transition enter-class="ease-out" enter-to-class="translate-x-0" enter-active-class="translate-x-full"
                leave-class="ease-out" leave-to-class="translate-y-0" leave-active-class="-translate-x-full">
                <div class="relative flex flex-col w-full h-full transition-transform duration-200 bg-white transform-gpu dark:bg-navy-750"
                    ...
                    <div v-if="activeTab === 'tabHome'" x-transition:enter="transition-all duration-500 easy-in-out"
                        ...
                        <div class="mt-4">
                            ...
                            <div class="px-2 mt-4 space-y-3">
                                <div v-for="message in lastMessage.messages"
                                    class="flex flex-col justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">

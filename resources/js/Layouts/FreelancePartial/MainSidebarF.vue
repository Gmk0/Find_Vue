        ...
        <div class="main-sidebar ">
            <div
                ...
                <div class="flex flex-col pt-6 space-y-4 overflow-y-auto is-scrollbar-hidden grow">
                    ...
                    <!-- Apps -->
                    <router-link :to="{ name: 'user.commandes' }"
                    ...
                    <!-- Components -->
                    <router-link :to="{ name: 'user.missions' }"
                    ...
                    <!-- Elements -->
                    <router-link :to="{ name: 'user.transactions' }"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="avatar h-14 w-14">
                                                <img class="object-cover rounded-full" src="" alt="">
                                            </div>
                                            <div>
                                                <a href="#"
                                        ...
                                        <div class="flex flex-col pt-2 pb-5">
                                            ...
                                            <a href="{{route('freelance.messages')}}"
                                                class="flex items-center px-4 py-2 space-x-3 tracking-wide transition-all outline-none group hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
                                                <div
                                                    class="flex items-center justify-center w-8 h-8 text-white rounded-lg bg-info">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5" fill="none"
                                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                            ...
                                            <a href="#"
                                                class="flex items-center px-4 py-2 space-x-3 tracking-wide transition-all outline-none group hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
                                                <div
                                                    class="flex items-center justify-center w-8 h-8 text-white rounded-lg bg-error">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5" fill="none"
                                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round"

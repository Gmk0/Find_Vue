     ...
     <div class="flex flex-col min-h-screen gap-6 px-4 lg:mx-auto md:p-6 md:max-w-7xl md:container px-auto bg-inherit">
            ...
            <div>
                ...
                <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
                        ...
                        <div style="top:8rem;" class="sticky p-4 bg-white rounded-[25px] dark:bg-gray-900 sm:p-5">
                            <div class="flex items-center space-x-4">
                                <div class="avatar h-14 w-14">
                                    ...
                                    <img v-else class="rounded-full" :src="$page.props.auth.user.profile_photo_url" alt="">
                            ...
                            <ul class="mt-6 space-y-1.5 font-inter font-medium">
                                ...
                                <li>
                                    <a @click="activeTab = 'Security'"
                                        ...
                                        <span
                                            :class="activeTab === 'Security' ? 'dark:text-white text-slate-800' : 'transition-colors text-slate-400 group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200'">Securité</span>
                                    </a>
                                </li>
                    ...
                    <div v-cloak v-show="activeTab === 'AccountP'" class="col-span-12 lg:col-span-8">
                    <transition
                    enter-class="transition-all duration-300 easy-in-out"
                    enter-start-class="'opacity-0 [transform:translate3d(1rem,0,0)]'"
                    enter-end-class="'opacity-100 [transform:translate3d(0,0,0)]'"
                    >
                    ...
                    <div  v-if="activeTab === 'Security'" x-transition:enter="transition-all duration-300 easy-in-out"

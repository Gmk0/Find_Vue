            ...
            <div class="overflow-hidden bg-white rounded-lg shadow-md">
                        ...
                        <div class="grid grid-cols-1 px-6 py-4 lg:grid-cols-2">
                            ...
                            <p class="mb-4 text-base text-gray-600 md:mb-2 dark:text-gray-300">Date de livraison :
                                ...
                                <span class="text-green-500">{{ order.feedback?.created_at }}</span>
                            </p>
                    ...
                    <div class="px-6 py-4 border-t border-gray-200">
                      ...
                      <div class="px-6 py-4 border-t border-gray-300">
                        ...
                        <div class="flex items-center mt-4">
                               <Avatar :image="'/storage/' + order.freelance_user.profile_photo_path"
                    ...
                    <div class="px-6 py-4 border-t border-gray-200">
                        ...
                        <div class="grid grid-cols-2 gap-2 lg:grid-cols-5 md:grid-cols-4 lg:flex-row">
                            ...
                            <div v-if="order.feedback?.etat == 'Livré'" class="w-full">
                                  <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">feedback</button>
                    ...
                    <div>
                        <div x-data="{open:false}" class="px-6 py-4 border-t border-gray-200">
                            ...
                            <div x-cloak x-show="open" x-collapse class="pt-4">
                                <p class="text-base text-gray-600 dark:text-gray-300">Numéro de transaction :
                                    <span class="text-lg font-bold">#{{ $order -> transaction -> transaction_number }}</span>

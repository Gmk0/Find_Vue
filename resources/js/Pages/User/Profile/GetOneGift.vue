    ...
    <div class="min-h-screen py-2 pt-16 bg-gray-100 md:px-6 dark:bg-gray-900">
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <Link :href="route('gift',$page.props.auth.user.id)" href="#"
        ...
        <div class="container relative px-4 py-4 lg:mx-auto">
            ...
            <div class="relative flex flex-col gap-4 lg:flex-row lg:space-x-4">
                    ...
                    <div class="flex lg:sticky lg:top-[8rem] flex-col gap-2 p-4 card-sticky ">
                        ...
                        <div class="p-2 bg-white rounded-md shadow-lg lg:sticky dark:bg-gray-800">
                            ...
                            <div class="mt-2 sm:col-span-8 lg:col-span-7">
                                ...
                                <h2
                                    class="block  text-base my-4 lg:text-lg font-bold text-gray-800 truncate lg:hidden dark:text-gray-300 ">
                                    {{ service.title }}
                                </h2>
                                <section aria-labelledby="information-heading" class="mt-1 ">
                                    ...
                                    <div class="flex justify-between my-3">
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex items-center">
                                                ...
                                                <span class="text-sm font-semibold text-gray-700 dark:text-gray-100">(2)
                                                </span>
                                            </div>

                                            <p class="sr-only">3 out of 5 stars</p>
                                            <a href="#"
                                                class="ml-3 text-sm font-medium text-amber-600 hover:text-indigo-500">{{
                                                    service.orderCount }}
                                                reviews</a>
                                        </div>
                                    ...
                                    <div class="flex justify-between gap-2 px-4 ">
                                        ...
                                        <p class="text-lg font-bold text-amber-600">Gratuit</p>
                                    </div>
                                ...
                                <section aria-labelledby="options-heading" class="px-4 mt-1">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex mb-8">
                                            <button @click="getGift()" type="button" id=""
                ...
                <div class="w-full lg:px-4 px-2 bg-white dark:bg-gray-800 md:w-2/3">
                    <div class="lg:p-4 dark:bg-gray-800">
                        <div class="flex flex-col mb-4">
                                        ...
                                        <div class="py-5 min-h-64">
                                            ...
                                            <div class="grid grid-cols-2 gap-4 mb-6">
                                                <div class="col-span-2">
                                                    <p class="font-bold text-base text-gray-500 dark:text-gray-200">Besoin
                                                        pour ce service :</p>
                            ...
                            <div class="px-4 mt-6">
                                ...
                                <div class="text-base text-gray-700 max-w-md break-words dark:text-gray-100">
                    ...
                    <div
                        ...
                        <div class="flex flex-col items-start justify-between mb-4">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="rounded-full h-2 w-2">
                                </span>

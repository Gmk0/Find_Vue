...
<template>
    <div class="flex flex-col min-h-screen gap-6 px-4 lg:mx-auto md:p-6 md:max-w-7xl md:container px-auto bg-inherit">
        ...
        <div class="flex flex-col">
            ...
            <h1 class="mt-4 text-3xl font-bold text-black dark:text-white">Transactions</h1>
        ...
        <div class="mt-4">
           ...
           <section class="grid gap-1 p-6 bg-white rounded-lg shadow dark:bg-gray-800 max-w-7xl dark:text-gray-200 lg:grid-cols-2">
            ...
            <div >
                ...
                <div class="flex items-center mb-4">
                    ...
                    <span class="flex gap-1 text-gray-900 dark:text-gray-100">
                        ...
                        <div v-if="transaction.payment_method['brand']">
                              <svg v-if="transaction.payment_method['brand'] =='visa'" class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 83">
                                <defs>
                            ...
                            <svg v-else-if="transaction.payment_method['brand'] == 'mastercard'" class="w-7 h-7" aria-hidden="true" enable-background="new 0 0 780 500" viewBox="0 0 780 500"
                        ...
                        <span>••• {{ transaction.payment_method['last4'] }}</span>
                ...
                <div v-if="transaction.status =='completed'" class="mt-6">
            ...
            <div class="mt-4">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <span class="text-gray-900 dark:text-gray-200">{{ order.order_numero }}</span>
                            <div class="px-2">
                                ...
                                <Button label="voir" size="small" outlined />
                                </Link>
                            </div>
                    </div>
             ...
             <div v-else class="flex items-start">
                ...
                <div v-if="transaction.missions != null"  class="p-6 bg-white rounded-lg ">
                    ...
                    <div class="flex items-center mb-4">
                        <span class="mr-2 text-gray-600 dark:text-gray-400">Date de creation :</span>
                        <span class="text-gray-900 dark:text-gray-200">{{ transaction.mission.created_at }}</span>
                    </div>

                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <Link :href="route('freelance.transactions')" class="flex items-center">
                        ...
                        <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{transaction.transaction_numero}}</span>
                                </div>
                            </li>
                    </ol>
                </nav>

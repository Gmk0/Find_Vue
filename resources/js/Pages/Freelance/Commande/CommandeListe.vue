            ...
            <div>
                ...
                <div class="card">
                    <DataTable stripedRows paginator :rows="10" :rowsPerPageOptions="[2, 10, 20, 50]"
                        :value="commandes.data" tableStyle="min-width: 50rem">

                        <template #empty> Pas de commande pour l'instant. </template>
                        ...
                        <Column header="status">
                         ...
                         <Column header="etat">
                                <template #body="slotProps">
                                    <Tag :value="slotProps.data.feedback.etat" :severity="getSeverityEtat(slotProps.data.feedback)" />
                        ...
                        <Column :exportable="false" style="min-width:4rem">
                            <template #body="slotProps">
                                <Link :href="route('freelance.commandes.one', [slotProps.data.order_numero])">

                ...
                <div class="container flex items-center justify-between py-0 flex-wrap-inherit">
                    ...
                    <div navbar-menu
                        ...
                        <ul class="flex flex-col pl-0 mx-auto mb-0 list-none lg:flex-row xl:ml-auto">
                            <li>
                                <Link :herf="route('home')" class="flex items-center px-4 py-2 mr-2 text-sm font-normal text-white transition-all duration-250 lg-max:opacity-0 lg-max:text-slate-700 ease-soft-in-out lg:px-2 lg:hover:text-white/75"
                                    aria-current="page" >
                            ...
                            <li>
                                <Link :herf="route('profile.show')" class="block px-4 py-2 mr-2 text-sm font-normal text-white transition-all duration-250 lg-max:opacity-0 lg-max:text-slate-700 ease-soft-in-out lg:px-2 lg:hover:text-white/75"
                                    >

    ...
    <div class="min-h-screen pt-16">
        <div class="pb-8">
            ...
            <div class="px-6 m-auto text-gray-900 xl:container md:px-12 xl:px-16">
                <div
                    class="md:bg-gray-100 dark:bg-gray-900 lg:p-16 p-8 rounded-[4rem] space-y-6 md:flex md:gap-6 justify-center md:space-y-0 lg:items-center">
                    ...
                    <div class="md:7/12 lg:w-1/2">
                        ...
                        <div>
                            <Link :href="route('register.etape.1')" class="block w-full select-none rounded-lg bg-amber-600 py-2 px-2 text-center align-middle font-sans text-sm font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-amber-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 dark:text-gray-50">
                                Inscrivez-vous gratuitement, créez votre service, et proposez votre travail à notre
                                public
                                international.
                            </p>
                        </div>

                ...
                <div class="container px-4 mx-auto">
                    ...
                    <div class="grid grid-cols-1 gap-8 p-4 bg-white rounded-lg dark:bg-gray-800 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+243 8447-20350</p>
                        </div>
                    </div>

                    <div class="p-4 py-6 bg-white rounded-lg dark:bg-gray-800 md:p-8">
                        ...
                        <div>
                            <form @submit.prevent="contacter()">
                                ...
                                <button type="submit" class="
                                                block mt-4 w-full select-none rounded-lg bg-amber-600 py-2 px-2 text-center align-middle

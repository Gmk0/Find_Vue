...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="grid grid-cols-2 gap-2"><div class="mt-4 W-full">`);
      ...
      _push(`</div></div><div class="grid grid-cols-2 gap-2"><div class="w-full col-span-1 mb-4">`);
      _push(ssrRenderComponent(_component_InputLabel, {
        for: "titre",
        value: "Prix"
      }, null, _parent));
      ...
      _push(`</div></div><div class="grid grid-cols-2 gap-2 mt-4"><div class="w-full col-span-2 mb-4">`);
      _push(ssrRenderComponent(_component_InputLabel, {
        for: "description",
        value: "Description"
      }, null, _parent));
      ...
      _push(`</div></div></div><div class="grid grid-cols-2 gap-2"><div class="w-full col-span-1 mb-4">`);
      _push(ssrRenderComponent(_component_InputLabel, {
        for: "support",
        value: "support"
      }, null, _parent));

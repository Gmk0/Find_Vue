...
import { _ as _sfc_main$4 } from "./TextInput-4f082d1a.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.js";
const NavGuest_vue_vue_type_style_index_0_scoped_1606bb4b_lang = "";
const _sfc_main$2 = {
  setup() {
    return {};
  }
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<nav${ssrRenderAttrs(mergeProps({ class: "absolute top-0 z-30 flex flex-wrap items-center justify-between w-full px-4 py-2 mt-6 mb-4 shadow-none lg:flex-nowrap lg:justify-start" }, _attrs))} data-v-1606bb4b><div class="container flex items-center justify-between py-0 flex-wrap-inherit" data-v-1606bb4b>`);
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="to-orange-400" data-v-1606bb4b${_scopeId}>FIND</span>`);
      } else {
        return [
  ...
  _push(`<div navbar-menu class="items-center flex-grow transition-all ease-soft duration-350 lg-max:bg-white lg-max:max-h-0 lg-max:overflow-hidden basis-full rounded-xl lg:flex lg:basis-auto" data-v-1606bb4b><ul class="flex flex-col pl-0 mx-auto mb-0 list-none lg:flex-row xl:ml-auto" data-v-1606bb4b><li data-v-1606bb4b>`);
  _push(ssrRenderComponent(_component_Link, {
    href: _ctx.route("home"),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="mr-1 text-white lg-max:text-slate-700 fa fa-chart-pie opacity-60" data-v-1606bb4b${_scopeId}></i> Accueil `);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="mr-1 text-white lg-max:text-slate-700 fa fa-user opacity-60" data-v-1606bb4b${_scopeId}></i> Profile `);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="mr-1 text-white lg-max:text-slate-700 fas fa-key opacity-60" data-v-1606bb4b${_scopeId}></i> Connexion `);
      } else {
        return [
...
const NavGuest = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-1606bb4b"]]);
const CardGuest_vue_vue_type_style_index_0_scoped_e0e0eb2c_lang = "";
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_FooterGuest = resolveComponent("FooterGuest");
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-e0e0eb2c><main class="mt-0 transition-all duration-200 dark:bg-gray-900 ease-soft-in-out" data-v-e0e0eb2c><section class="min-h-screen pt-4 mb-32" data-v-e0e0eb2c><div class="relative flex items-start pt-12 pb-56 mx-6 overflow-hidden bg-center bg-cover min-h-50-screen rounded-xl" style="${ssrRenderStyle({ "background-image": "url('/images/logo/ff3.png')" })}" data-v-e0e0eb2c><span class="absolute top-0 left-0 w-full h-full bg-center bg-cover opacity-50 gradient2 from-gray-900 to-slate-800" data-v-e0e0eb2c></span><div class="container z-10" data-v-e0e0eb2c><div class="flex flex-wrap justify-center -mx-3" data-v-e0e0eb2c><div class="w-full max-w-full px-3 mx-auto mt-0 text-center lg:flex-0 shrink-0 lg:w-5/12" data-v-e0e0eb2c><h1 class="mt-12 mb-2 text-white" data-v-e0e0eb2c>`);
  ssrRenderSlot(_ctx.$slots, "title", {}, null, _push, _parent);
  _push(`</h1><p class="text-white" data-v-e0e0eb2c>`);
  ssrRenderSlot(_ctx.$slots, "description", {}, null, _push, _parent);
  _push(`</p></div></div></div></div><div class="container" data-v-e0e0eb2c><div class="flex flex-wrap -mx-3 -mt-48 md:-mt-56 lg:-mt-48" data-v-e0e0eb2c><div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0 md:w-7/12 lg:w-5/12 xl:w-4/12" data-v-e0e0eb2c>`);
...
const CardGuest = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-e0e0eb2c"]]);

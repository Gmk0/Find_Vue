...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li><span class="mx-2 text-base">&gt;</span></li><li class="text-gray-700 dark:text-gray-200"> Liste </li></ul></nav></div><h1 class="text-3xl font-bold text-black dark:text-white">Transactions</h1></div></div>`);
    };
  }
});

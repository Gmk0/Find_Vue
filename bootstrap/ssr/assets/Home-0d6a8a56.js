...
import { _ as _sfc_main$2 } from "./WebLayout-24abe450.js";
import { Swiper, SwiperSlide } from "swiper/vue";
import { f as useStore, h as homeSetting, i as useMissions } from "./userInfo-1488cc9b.js";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div><div class="flex flex-col w-full lg:mt-6 2xl:mt-10 mt-6"><div class="relative"><form class="relative flex p-1 mb-4 bg-white shadow-2xl lg:dark:bg-white rounded-xl 2xl:p-4 md:p-2"><input required${ssrRenderAttr("value", search.value)} class="w-full 2xl:p-6 p-4 mr-2 text-gray-600 border-white focus:border-white rounded-xl" type="text"><button type="submit" class="px-6 py-3 ml-auto text-center transition rounded-lg bg-skin-fill"><span class="hidden font-semibold text-white md:block"> Recherche </span><svg xmlns="http://www.w3.org/2000/svg" class="w-5 mx-auto text-white md:hidden" fill="currentColor" viewBox="0 0 16 16"><path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"></path></svg></button></form>`);
      if (searchPerformed.value) {
        ...
        _push(`<div class="mt-2 p-2"><button class="btn btn-sm btn-circle btn-outline"><svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`</div></div><p class="mt-2 text-center 2xl:text-lg text-gray-100">Catégories les plus populaires</p></div></div></div>`);
    };
  }
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Link, {
        ...
        class: "mt-4 md:mt-0 mx-auto text-center box-border w-10/12 2xl:py-3 2xl:text-lg rounded-md border border-amber-500/20 px-8 py-2.5 font-semibold text-amber-600 shadow-md shadow-amber-500/10 hover:bg-gray-100 duration-200"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</div><div class="mt-4 mb-2 text-center"><h1 class="text-xl text-gray-500">Nos partenaires</h1></div><div class="grid grid-cols-2 gap-6 mx-6 mt-6 md:mx-0 px-auto md:gap-2 md:grid-cols-3"><img src="/images/brand/influeworld.png" alt="influeworld" class="w-32 h-16 px-5 py-3 xl:w-36 xl:py-auto xl:px-auto xl:h-20 duration-200 grayscale hover:grayscale-0 border rounded-lg shadow-md cursor-pointer bg-gray-50 border-blue-300/20 shadow-blue-500/5 hover:scale-95 sm:w-36"><img src="/images/brand/makutano.png" alt="makutano" class="w-32 h-16 px-5 xl:px-auto xl:py-auto py-3 xl:w-36 xl:h-20 duration-200 grayscale hover:grayscale-0 border rounded-lg shadow-md cursor-pointer bg-gray-50 border-blue-300/20 shadow-blue-500/5 hover:scale-95 sm:w-36"><img src="/images/brand/silikin.png" alt="silikin" class="w-32 h-16 px-5 py-3 xl:px-auto xl:py-auto xl:w-36 xl:h-20 duration-200 border grayscale hover:grayscale-0 rounded-lg shadow-md cursor-pointer bg-gray-50 border-blue-300/20 shadow-blue-500/5 hover:scale-95 sm:w-36"></div></div><div class="hidden px-4 lg:block lg:w-1/12"></div><div data-aos="fade-left" data-aos-duration="500" class="hidden w-full px-4 lg:block md:w-6/12"><div class="lg:ml-auto lg:text-right"><div class="relative z-10 inline-block pt-11 lg:pt-0"><img src="/images/hero/women.jpeg" alt="hero div img" class="w-3/4 rounded-full lg:ml-auto"></div></div></div></div></div></div><div id="talkAbout" class="bg-white dark:bg-gray-800 lg:min-h-screen"><div class="container max-w-6xl 2xl:max-w-7xl 2xl:p-2 p-4 m-4 mx-auto md:p-6"><div class="mb-10 xl:mb-14 text-center"><span class="font-medium text-amber-600">Presentation</span><h1 class="text-2xl font-bold text-slate-700 dark:text-gray-200">Ils en Parlent mieux Que nous</h1></div><div class="my-10">`);
      _push(ssrRenderComponent(unref(Swiper), {
        class: "flex xl:py-12 py-8",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(SwiperSlide), { class: "mb-8 xl:mb-12" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="!bg-transparent px-2 md:px-0"${_scopeId2}><div class="px-2 bg-white border border-gray-300 dark:border-gray-300 rounded-3xl dark:bg-gray-800 dark:shadow-none md:mx-auto lg:w-11/12 xl:w-8/12"${_scopeId2}><div class="grid md:grid-cols-5"${_scopeId2}><div class="w-full m-2 h-50 xl:h-72 aspect-w-8 aspect-h-9 md:col-span-2 rounded-2xl"${_scopeId2}><iframe class="rounded-sm w-full h-full aspect-video hover:aspect-square" src="https://www.youtube.com/embed/rw_3Yv-rhZM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen${_scopeId2}></iframe></div><div class="p-6 mx-auto space-y-6 text-center md:col-span-3 sm:p-8"${_scopeId2}><div class="w-20 xl:w-28 mx-auto"${_scopeId2}><img src="images/brand/influnet.jpg" alt="company logo" loading="lazy"${_scopeId2}></div><p class="dark:text-gray-200 xl:text-lg"${_scopeId2}><span class="font-serif"${_scopeId2}></span> Find est une plateforme incontournable pour tous les demandeurs de services. J&#39;ai été impressionné par la qualité des freelances proposés. <span class="font-serif"${_scopeId2}>&quot;</span></p><h6 class="text-lg font-semibold leading-none dark:text-gray-200"${_scopeId2}>Georges Mk</h6></div></div></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "!bg-transparent px-2 md:px-0" }, [
                      createVNode("div", { class: "px-2 bg-white border border-gray-300 dark:border-gray-300 rounded-3xl dark:bg-gray-800 dark:shadow-none md:mx-auto lg:w-11/12 xl:w-8/12" }, [
                        createVNode("div", { class: "grid md:grid-cols-5" }, [
                          createVNode("div", { class: "w-full m-2 h-50 xl:h-72 aspect-w-8 aspect-h-9 md:col-span-2 rounded-2xl" }, [
                            createVNode("iframe", {
                              class: "rounded-sm w-full h-full aspect-video hover:aspect-square",
                          ...
                          createVNode("div", { class: "p-6 mx-auto space-y-6 text-center md:col-span-3 sm:p-8" }, [
                            createVNode("div", { class: "w-20 xl:w-28 mx-auto" }, [
                              createVNode("img", {
                            ...
                            createVNode("p", { class: "dark:text-gray-200 xl:text-lg" }, [
            ...
            _push2(ssrRenderComponent(unref(SwiperSlide), { class: "mb-8" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="!bg-transparent px-2 md:px-0"${_scopeId2}><div class="px-2 bg-white border border-gray-100 dark:border-gray-300 rounded-3xl dark:bg-gray-800 dark:shadow-none md:mx-auto lg:w-11/12 xl:w-8/12"${_scopeId2}><div class="grid md:grid-cols-5"${_scopeId2}><div class="w-full m-2 xl:h-72 h-50 aspect-w-8 aspect-h-9 md:col-span-2 rounded-2xl"${_scopeId2}><iframe class="rounded-sm w-full h-full aspect-video hover:aspect-square" src="https://www.youtube.com/embed/rw_3Yv-rhZM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen${_scopeId2}></iframe></div><div class="p-6 mx-auto space-y-6 text-center md:col-span-3 sm:p-8"${_scopeId2}><div class="w-20 xl:w-28 mx-auto"${_scopeId2}><img src="images/brand/influnet.jpg" alt="company logo" loading="lazy"${_scopeId2}></div><p class="dark:text-gray-200 xl:text-lg"${_scopeId2}><span class="font-serif"${_scopeId2}></span> Find est un outil essentiel pour tous ceux qui cherchent à trouver des freelances qualifiés. La plateforme est vraiment bien conçue et facile à utiliser <span class="font-serif"${_scopeId2}>&quot;</span></p><h6 class="text-lg font-semibold leading-none dark:text-gray-200"${_scopeId2}>Ulrich Lukemba</h6></div></div></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "!bg-transparent px-2 md:px-0" }, [
        ...
        _push(ssrRenderComponent(_component_Link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<h4 class="mt-3 mb-1 md:text-[20px] text-[16px] font-semibold text-slate-600 duration-200 group-hover:text-white"${_scopeId}>${ssrInterpolate(category.name)}</h4>`);
            } else {
              return [
      ...
      _push(`<!--]--></div></div></div>`);
      if (getMissions.value != null) {
        _push(`<div class="bg-gray-50 lg:min-h-screen dark:bg-gray-900"><div class="max-w-6xl px-8 py-6 mx-auto md:px-6"><div class="mb-10 text-center"><span class="font-medium text-amber-600">Mission</span><h1 class="text-2xl font-bold text-slate-700 dark:text-gray-200 sm:text-xl">Découvrez Quelques Missions</h1></div><div class="py-4 mx-2"><div class="flex items-end justify-end mb-2"><div class="flex gap-4"><button class="w-10 h-10 p-0 rounded-full btn2 prev-btn hover:bg-slate-300/20 focus:bg-slate-300/20 dark:active:bg-slate-300/25 active:bg-slate-100/25 disabled:pointer-events-none disabled:select-none disabled:opacity-60 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 19l-7-7 7-7"></path></svg></button><button class="w-10 h-10 p-0 rounded-full btn2 next-btn hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 disabled:pointer-events-none disabled:select-none disabled:opacity-60 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5l7 7-7 7"></path></svg></button></div></div>`);
        _push(ssrRenderComponent(unref(Swiper), {
            ...
            if (_push2) {
              ...
              ssrRenderList(getMissions.value, (mission) => {
                _push2(ssrRenderComponent(unref(SwiperSlide), { class: "p-2" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="mb-4 p-2 lg:flex-col rounded-md shadow-md"${_scopeId2}><img class="object-cover object-center w-full h-48 bg-center bg-cover shrink-0" src="/images/illustrations/missionF.svg" alt="image"${_scopeId2}><div class="flex flex-col w-full px-4 py-3 bg-white grow sm:px-5"${_scopeId2}><div class="flex items-center justify-between"${_scopeId2}><a class="text-xs+ text-info" href="#"${_scopeId2}>${ssrInterpolate(mission.category.name)}</a><div class="-mr-1.5 flex space-x-1"${_scopeId2}><button class="hidden p-0 rounded-full btn2 h-7 w-7 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"${_scopeId2}><svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"${_scopeId2}></path></svg></button><div class="p-2"${_scopeId2}></div></div></div><div${_scopeId2}>`);
                      ...
                      _push3(`</div><p class="mt-1 line-clamp-3"${_scopeId2}>`);
                      if (!showMore.value) {
                        _push3(`<div class="max-w-xs break-words"${_scopeId2}>${ssrInterpolate(truncateText(mission.description, 70))}</div>`);
                      } else {
                        _push3(`<div class="max-w-xs break-words"${_scopeId2}>${ssrInterpolate(mission.description)}</div>`);
                      }
                      ...
                      _push3(`</p><div class="grow"${_scopeId2}><div class="flex items-center mt-2 text-xs"${_scopeId2}><a href="#" class="flex items-center space-x-2 hover:text-slate-800 dark:hover:text-navy-100"${_scopeId2}><div class="w-6 h-6 avatar"${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_Photo, {
                        user: mission.user,
                        taille: "16"
                      }, null, _parent3, _scopeId2));
                      _push3(`</div><span class="line-clamp-1"${_scopeId2}>${ssrInterpolate(mission.user.name)}</span></a><div class="self-stretch w-px mx-3 my-1 bg-slate-200 dark:bg-navy-500"${_scopeId2}></div><span class="shrink-0 text-slate-400 dark:text-navy-300"${_scopeId2}>${ssrInterpolate(mission.created_at)}</span></div></div><div class="flex justify-between gap-4 mt-1"${_scopeId2}><div class="flex items-center"${_scopeId2}><h1 class="text-lg font-bold text-amber-600"${_scopeId2}>${ssrInterpolate(mission.budget)} $</h1></div>`);
                      if (mission.status == "completed") {
                        ...
                        _push3(`</div>`);
                      } else if (mission.status == "pending" && _ctx.$page.props.auth.user != null) {
                      ...
                      return [
                        createVNode("div", { class: "mb-4 p-2 lg:flex-col rounded-md shadow-md" }, [
                          createVNode("img", {
                            class: "object-cover object-center w-full h-48 bg-center bg-cover shrink-0",
                            src: "/images/illustrations/missionF.svg",
                            alt: "image"
                          }),
                          createVNode("div", { class: "flex flex-col w-full px-4 py-3 bg-white grow sm:px-5" }, [
                            ...
                            createVNode("div", { class: "grow" }, [
                              createVNode("div", { class: "flex items-center mt-2 text-xs" }, [
                                createVNode("a", {
                                  ...
                                  createVNode("div", { class: "w-6 h-6 avatar" }, [
                            ...
                            createVNode("div", { class: "flex justify-between gap-4 mt-1" }, [
                              createVNode("div", { class: "flex items-center" }, [
                                createVNode("h1", { class: "text-lg font-bold text-amber-600" }, toDisplayString(mission.budget) + " $", 1)
                              ]),
                              mission.status == "completed" ? (openBlock(), createBlock("div", { key: 0 }, [
                                createVNode(_component_Button, {
                                  size: "small",
                                  outlined: "",
                                  severity: "success",
                              ...
                              ])) : mission.status == "active" ? (openBlock(), createBlock("div", { key: 1 }, [
                                createVNode(_component_Button, {
                                  size: "small",
                                  outlined: "",
                                  severity: "success",
                              ...
                              ])) : mission.status == "pending" && _ctx.$page.props.auth.user != null ? (openBlock(), createBlock("div", {
                                key: 2,
      ...
      ssrRenderList(faqsGet.value, (faq, index) => {
        ...
        _push(ssrRenderComponent(unref(Collapse), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<p class="mt-2 text-sm text-gray-800 dark:text-white"${_scopeId}>${ssrInterpolate(faq.reponses)}</p>`);
            } else {
              return [
                createVNode("p", { class: "mt-2 text-sm text-gray-800 dark:text-white" }, toDisplayString(faq.reponses), 1)
              ];
            }
          }),
          _: 2

...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen py-2 pt-16 bg-gray-100 md:px-6 dark:bg-gray-900" }, _attrs))}><div class="hidden px-2"> All/Service </div><div class="px-4 mt-4"><nav class="flex" aria-label="Breadcrumb"><ol class="inline-flex items-center space-x-1 md:space-x-3"><li class="inline-flex items-center">`);
      ...
      _push(`<div class="flex justify-between gap-2 px-4"><p class="py-2 text-lg text-gray-800">${ssrInterpolate(level.value)}</p><p class="text-lg font-bold text-amber-600">Gratuit</p></div><div><div id="" class="mt-4"><div class="px-4"><ul class="flex gap-4"></ul></div></div></div></section><section aria-labelledby="options-heading" class="px-4 mt-1"><h3 id="options-heading" class="sr-only">Service options</h3><div><div class="flex justify-between mt-4"><p class="flex gap-2 font-medium text-gray-700 dark:text-gray-100"><span><i class="pi pi-clock"></i></span>`);
      ...
      _push(`<p class="block text-gray-700 truncate dark:text-gray-300">${ssrInterpolate(service.value.category.name)}</p></div></div><div class="text-base text-gray-700 max-w-md break-words dark:text-gray-100">${ssrInterpolate(service.value.freelance.description)}</div></div></div></div></div></div></div><div class="px-4 mt-4"><div class="px-4"><p class="text-lg font-bold text-gray-800 dark:text-gray-200">Du meme Categorie</p></div><div class="grid gap-4 px-4 py-4 mx-auto md:grid-cols-4"><!--[-->`);
      ...
      _push(` * `);
      if (progress.value) {
        _push(`<div><div><div class="fixed top-0 left-0 z-50 flex items-center justify-center w-screen h-screen" style="${ssrRenderStyle({ "background": "rgba(0, 0, 0, 0.3)" })}"><div class="flex flex-col items-center px-5 py-2 bg-white border rounded-lg"><div class="relative block w-20 h-5 mt-2 loader-dots"><div class="absolute top-0 w-3 h-3 mt-1 bg-green-500 rounded-full"></div><div class="absolute top-0 w-3 h-3 mt-1 bg-green-500 rounded-full"></div><div class="absolute top-0 w-3 h-3 mt-1 bg-green-500 rounded-full"></div><div class="absolute top-0 w-3 h-3 mt-1 bg-green-500 rounded-full"></div></div><div class="mt-2 text-xs font-medium text-center text-gray-500"> Obtention en cours... </div></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);

...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    const getSeverityEtat = (commande) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_DataTable, {
        ...
        empty: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Pas de commande pour l&#39;instant. `);
          } else {
            return [
              createTextVNode(" Pas de commande pour l'instant. ")
            ];
          }
        }),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_Column, { header: "etat" }, {
              body: withCtx((slotProps, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_Tag, {
                    value: slotProps.data.feedback.etat,
                    severity: getSeverityEtat(slotProps.data.feedback)
                  }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_component_Tag, {
            ...
            _push2(ssrRenderComponent(_component_Column, { header: "progression" }, {
              body: withCtx((slotProps, _push3, _parent3, _scopeId2) => {
                if (_push3) {
              ...
              body: withCtx((slotProps, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_Link, {
                    href: _ctx.route("freelance.commandes.one", [slotProps.data.order_numero])
                  }, {
            ...
            return [
              ...
              createVNode(_component_Column, { header: "etat" }, {
                body: withCtx((slotProps) => [
                  createVNode(_component_Tag, {
                    value: slotProps.data.feedback.etat,
                    severity: getSeverityEtat(slotProps.data.feedback)
              ...
              createVNode(_component_Column, { header: "progression" }, {
                body: withCtx((slotProps) => [
                  createVNode(_component_ProgressBar, {
                    value: slotProps.data.progress
                  }, null, 8, ["value"])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Freelance/Commande/CommandeListe.vue");

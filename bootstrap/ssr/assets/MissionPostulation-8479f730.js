  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (missionResponce.value.length === 0) {
        _push(`<div class="text-lg text-gray-800"> Vous avez zero Proposition pour cette mission </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);

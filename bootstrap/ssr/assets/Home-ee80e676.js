    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.categories, (category) => {
        ...
        _push(ssrRenderComponent(_component_Link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", "/storage/" + category.illustration)} class="w-20 h-20 rounded-md" alt=""${_scopeId}><h4 class="mt-3 mb-1 md:text-[20px] text-[16px] font-semibold text-slate-600 duration-200 group-hover:text-white"${_scopeId}>${ssrInterpolate(category.name)}</h4>`);
            } else {
              return [
                createVNode("img", {

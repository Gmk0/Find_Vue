  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Panel, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form class="grid grid-cols-1 gap-4 p-4 border rounded-md dark:border-gray-300 min-h-72"${_scopeId}><div class="grid grid-cols-2 gap-2"${_scopeId}><div class="w-full col-span-1 mb-4"${_scopeId}>`);
            ...
            _push2(`</div></div><div class="grid grid-cols-2 gap-2"${_scopeId}><div class="mt-4 W-full"${_scopeId}>`);
            ...
            _push2(`</div></div><div class="grid grid-cols-2 gap-2"${_scopeId}><div class="w-full col-span-1 mb-4"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_InputLabel, {
              for: "titre",
              value: "Prix"
            }, null, _parent2, _scopeId));
            ...
            _push2(`</div></div><div class="grid grid-cols-2 gap-2 mt-4"${_scopeId}><div class="w-full col-span-2 mb-4"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_InputLabel, {
              for: "description",
              value: "Description"
            }, null, _parent2, _scopeId));
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_FileUpload, {
              ...
              empty: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p${_scopeId2}>Drag and drop files to here to upload.</p>`);
                } else {
                  return [

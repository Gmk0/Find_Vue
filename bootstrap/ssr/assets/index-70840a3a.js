...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div><div class="lg:min-h-screen px-4 pt-4 bg-white dark:bg-gray-800 md:px-8"><div class="flex justify-start"><h1 class="text-2xl font-semibold text-black dark:text-white"> Parcourir toutes les catégories </h1></div><!--[-->`);

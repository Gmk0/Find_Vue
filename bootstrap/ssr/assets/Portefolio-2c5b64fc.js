...
import { _ as _sfc_main$2 } from "./ServiceCard-fe502c1d.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative min-h-screen pt-16 overflow-auto" }, _attrs))}><div class="relative flex flex-col h-full bg-gray-100 dark:bg-gray-900 lg:flex-row"><aside class="w-full pb-4 mb-4 overflow-auto bg-white shadow-md dark:bg-gray-800 lg:w-4/12"><div class="sticky top-0"><div class="px-6 overflow-y-auto scrollbar-sm"><div class="flex items-center justify-center">`);

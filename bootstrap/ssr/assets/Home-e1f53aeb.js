import { ref, unref, withCtx, createTextVNode, toDisplayString, useSSRContext, computed, onMounted, resolveComponent, createVNode, openBlock, createBlock, createCommentVNode, withDirectives, vShow, Fragment, renderList } from "vue";
...
import { _ as _sfc_main$2 } from "./WebLayout-1f5db4b5.js";
import { Swiper, SwiperSlide } from "swiper/vue";
import { f as useStore, h as useMissions } from "./userInfo-2152bb8f.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Link, {
        ...
        class: "mt-4 md:mt-0 mx-auto text-center box-border w-10/12 rounded-md border border-amber-500/20 px-8 py-2.5 font-semibold text-amber-600 shadow-md shadow-amber-500/10 hover:bg-gray-100 duration-200"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      ssrRenderList(__props.categories, (category) => {
        ...
        _push(ssrRenderComponent(_component_Link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (category.illustration = true) {
                _push2(`<img${ssrRenderAttr("src", "/storage/" + category.illustration)} class="w-20 h-20 rounded-md" alt=""${_scopeId}>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              return [
                (category.illustration = true) ? (openBlock(), createBlock("img", {
                  key: 0,

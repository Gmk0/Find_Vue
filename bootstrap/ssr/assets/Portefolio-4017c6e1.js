...
import { _ as _sfc_main$2 } from "./ServiceCard-13af6be1.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(props.freelance.data.certificat, (certificat, index) => {
              _push2(`<div class="rounded-lg flex flex-col"${_scopeId}><div class="text-base font-bold text-gray-700 dark:text-gray-500"${_scopeId}><div class="flex gap-2 lg:justify-between"${_scopeId}><span${_scopeId}>Certifier </span><span class="block text-gray-700 dark:text-gray-200"${_scopeId}>${ssrInterpolate(certificat["certifier"])}</span></div></div><div class="text-base font-bold text-gray-700 dark:text-gray-500"${_scopeId}><div class="flex gap-2 lg:justify-between"${_scopeId}><span${_scopeId}> Par : </span><span class="text-gray-700 block dark:text-gray-200"${_scopeId}>${ssrInterpolate(certificat["delivrer"])} / ${ssrInterpolate(certificat["annee"])}</span></div></div><div class="text-base font-bold text-gray-700 dark:text-gray-500"${_scopeId}><div class="flex gap-2 lg:justify-between"${_scopeId}><span${_scopeId}> Année : </span><span class="text-gray-700 block dark:text-gray-200"${_scopeId}>${ssrInterpolate(certificat["annee"])}</span></div></div></div>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
              createVNode("div", { class: "p-4 text-sm leading-normal text-blue-gray-500/80" }, [
                (openBlock(true), createBlock(Fragment, null, renderList(props.freelance.data.certificat, (certificat, index) => {
                  return openBlock(), createBlock("div", { class: "rounded-lg flex flex-col" }, [
                    ...
                    createVNode("div", { class: "text-base font-bold text-gray-700 dark:text-gray-500" }, [
                      createVNode("div", { class: "flex gap-2 lg:justify-between" }, [
                        ...
                        createVNode("span", { class: "text-gray-700 block dark:text-gray-200" }, toDisplayString(certificat["delivrer"]) + " / " + toDisplayString(certificat["annee"]), 1)
                      ])
                    ]),
                    createVNode("div", { class: "text-base font-bold text-gray-700 dark:text-gray-500" }, [
                      createVNode("div", { class: "flex gap-2 lg:justify-between" }, [
                        createVNode("span", null, " Année : "),
                        createVNode("span", { class: "text-gray-700 block dark:text-gray-200" }, toDisplayString(certificat["annee"]), 1)
                      ])
                    ])
                  ]);
                }), 256))
              ...
              _push2(ssrRenderComponent(unref(SwiperSlide), null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<!--]--><div class="mt-auto p-4 rounded-md dark:bg-gray-700 bg-gray-200"${_scopeId2}>${ssrInterpolate(realisation.description)}</div>`);
                  } else {
                    return [
                      ...
                      createVNode("div", { class: "mt-auto p-4 rounded-md dark:bg-gray-700 bg-gray-200" }, toDisplayString(realisation.description), 1)
                    ];
                  }
                }),
                _: 2

...
import { _ as _sfc_main$2, B as BodyMessage } from "./BodyMessage-e67eb4fb.js";
import { M as MainSidebarUser } from "./OtherPanelUser-6c7b9fe1.js";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(props.Conversations.data, (freelance) => {
        _push(`<div class="px-2"><button class="flex cursor-pointer items-center justify-center py-2.5 hover:bg-slate-150 dark:hover:bg-navy-600"><div${ssrRenderAttrs(mergeProps({ class: "w-10 h-10 avatar" }, ssrGetDirectiveProps(_ctx, _directive_tooltip, freelance.freelanceUser.name, void 0, { right: true })))}>`);
        _push(ssrRenderComponent(_component_Photo, {
          user: freelance.freelanceUser
        }, null, _parent));

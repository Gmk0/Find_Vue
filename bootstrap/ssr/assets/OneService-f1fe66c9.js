...
import { _ as _sfc_main$1 } from "./WebLayout-faf69ce3.js";
...
import { d as cartStore } from "./userInfo-a25f65d4.js";
import "@vueuse/core";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
            ...
            ssrRenderList(props.service.data.files, (image, index) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img class="object-fill rounded-md h-full lg:h-10/12 swiper-lazy"${ssrRenderAttr("src", "/storage/" + image)}${ssrRenderAttr("alt", image)}${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        class: "object-fill rounded-md h-full lg:h-10/12 swiper-lazy",
                        src: "/storage/" + image,
                        alt: image
                      }, null, 8, ["src", "alt"])
                    ];
      ...
      _push(`</div></div><div class="hidden"><p class="mt-4 text-lg font-bold text-gray-800 md:text-2xl dark:text-gray-200">${ssrInterpolate(service.value.title)}</p></div><div class="mt-8 card">`);

  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (missionResponce.value.length === 0) {
        _push(`<div class="text-lg dark:text-gray-300 text-gray-800"> Vous n&#39;avez aucune proposition pour cette mission </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);

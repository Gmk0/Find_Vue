...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="lg:h-[23rem] h-52 overflow-hidden bg-white rounded-xl shadow-md dark:text-gray-200 dark:bg-gray-900"><div class="relative flex flex-row lg:flex-col"><div class="relative group w-[48%] lg:w-full">`);
      ...
      _push(`</div><div class="mt-2"><div class="flex items-center gap-1"><a href="" class="flex"><span class="text-xs md:flex">${ssrInterpolate(props.service.user.name)}</span></a></div></div><div class="flex justify-between mt-auto mb-2 md:mt-3"><div class=""><button class="hidden"></button></div><div class="flex items-center gap-2"><div class="text-gray-600"> a partir de </div><button class="bg-skin-fill p-2 text-white !rounded-br-xl !rounded-md"><span class="font-semibold">${ssrInterpolate(props.service.basic_price)} $</span></button></div></div></div></div></div></div>`);
    };
  }
};

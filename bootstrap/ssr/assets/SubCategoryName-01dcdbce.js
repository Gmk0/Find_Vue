...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="grid sticky top-0 col-span-12 gap-4 lg:grid-cols-12 lg:gap-2"></div><div class="flex flex-row justify-between gap-2 px-4 lg:col-span-3"><div class=""><div class="block m-2 lg:hidden">`);
      _push(ssrRenderComponent(_component_Button, {
        size: "small",
      ...
      _push(`</div></div><div class="block m-2 lg:hidden">`);

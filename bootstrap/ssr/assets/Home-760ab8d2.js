...
import { f as useStore, h as homeSetting, i as useMissions } from "./userInfo-b7520541.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="mt-4 mb-2 text-center"><h1 class="text-xl text-gray-500">Nos partenaires</h1></div><div class="grid grid-cols-2 gap-6 mx-6 mt-6 md:mx-0 px-auto md:gap-2 md:grid-cols-3"><img src="/images/brand/influeworld.png" alt="influeworld" class="w-32 h-16 px-5 py-3 duration-200 border rounded-lg shadow-md cursor-pointer xl:w-36 xl:py-auto xl:px-auto xl:h-20 grayscale hover:grayscale-0 bg-gray-50 border-blue-300/20 shadow-blue-500/5 hover:scale-95 sm:w-36"><img src="/images/brand/makutano.png" alt="makutano" class="w-32 h-16 px-5 py-3 duration-200 border rounded-lg shadow-md cursor-pointer xl:px-auto xl:py-auto xl:w-36 xl:h-20 grayscale hover:grayscale-0 bg-gray-50 border-blue-300/20 shadow-blue-500/5 hover:scale-95 sm:w-36"><img src="/images/brand/silikin.png" alt="silikin" class="w-32 h-16 px-5 py-3 duration-200 border rounded-lg shadow-md cursor-pointer xl:px-auto xl:py-auto xl:w-36 xl:h-20 grayscale hover:grayscale-0 bg-gray-50 border-blue-300/20 shadow-blue-500/5 hover:scale-95 sm:w-36"></div></div><div class="hidden px-4 lg:block lg:w-1/12"></div><div data-aos="fade-left" data-aos-duration="500" class="hidden w-full px-4 lg:block md:w-6/12"><div class="lg:ml-auto lg:text-right"><div class="relative z-10 inline-block pt-11 lg:pt-0"><img src="/images/hero/women.jpeg" alt="hero div img" class="w-3/4 rounded-full lg:ml-auto"></div></div></div></div></div></div><div id="talkAbout" class="bg-white dark:bg-gray-800 lg:min-h-screen xl:min-h-full"><div class="container max-w-6xl p-4 m-4 mx-auto 2xl:max-w-7xl 2xl:p-2 md:p-6"><div class="mb-10 text-center xl:mb-14"><span class="font-medium text-amber-600">Presentation</span><h1 class="text-2xl font-bold text-slate-700 dark:text-gray-200">Ils en Parlent mieux Que nous</h1></div><div class="my-10">`);
      _push(ssrRenderComponent(unref(Swiper), {
                ...
                _push2(ssrRenderComponent(unref(SwiperSlide), { class: "p-2" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      return [
                        createVNode("div", { class: "p-2 mb-4 rounded-md shadow-md lg:flex-col" }, [
                          createVNode("img", {
      ...
      ssrRenderList(faqsGet.value, (faq, index) => {
        _push(`<div><button class="${ssrRenderClass([index !== faqsGet.value.length - 1 && "border-b border-gray-400", "flex items-center justify-between w-full py-3 mt-4 font-bold text-gray-800 border-b dark:text-white"])}"><div class="text-left">${ssrInterpolate(faq.questions)}</div><svg style="${ssrRenderStyle(!expandedItems.value.includes(faq.id) ? null : { display: "none" })}" class="fill-current" viewBox="0 0 24 24" width="24" height="24"><path class="heroicon-ui" d="M12 22a10 10 0 110-20 10 10 0 010 20zm0-2a8 8 0 100-16 8 8 0 000 16zm1-9h2a1 1 0 010 2h-2v2a1 1 0 01-2 0v-2H9a1 1 0 010-2h2V9a1 1 0 012 0v2z"></path></svg><svg style="${ssrRenderStyle(expandedItems.value.includes(faq.id) ? null : { display: "none" })}" class="fill-current" viewBox="0 0 24 24" width="24" height="24"><path class="heroicon-ui" d="M12 22a10 10 0 110-20 10 10 0 010 20zm0-2a8 8 0 100-16 8 8 0 000 16zm4-8a1 1 0 01-1 1H9a1 1 0 010-2h6a1 1 0 011 1z"></path></svg></button>`);
        _push(ssrRenderComponent(unref(Collapse), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<p class="m-2 text-sm text-gray-800 dark:text-white"${_scopeId}>${ssrInterpolate(faq.reponses)}</p>`);
            } else {
              return [
                createVNode("p", { class: "m-2 text-sm text-gray-800 dark:text-white" }, toDisplayString(faq.reponses), 1)
              ];
            }
          }),
          _: 2

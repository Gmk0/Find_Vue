  ...
  setup(__props) {
    ...
    const effacer = () => {
      form.post(route("deleteMission"), {
        onError: (error) => {
          toast.add({ severity: "info", summary: "Message", detail: error.message, group: "br", life: 1e3 });
        }
      });
    };
    const remove = (index) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Dialog), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p${_scopeId}> Êtes-vous sûr de vouloir supprimer cette mission ? Veuillez noter que si vous avez déjà accepté une proposition pour cette mission, il sera impossible de la supprimer. Si vous êtes sûr, cliquez sur ‘Confirmer’. Sinon, cliquez sur ‘Annuler’ </p><div class="flex gap-6 justify-center mt-4"${_scopeId}><div${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Button, {
            ...
            return [
              ...
              createVNode("div", { class: "flex gap-6 justify-center mt-4" }, [

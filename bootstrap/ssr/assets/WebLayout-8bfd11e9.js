...
import { d as cartStore, a as useCategoryStore, e as useSubcategoriesStore, _ as _sfc_main$4 } from "./userInfo-1ade63c0.js";
...
const Navbar_vue_vue_type_style_index_0_scoped_e8c1cece_lang = "";
const _sfc_main$2 = {
  __name: "Navbar",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "z-[100]" }, _attrs))} data-v-e8c1cece><div class="${ssrRenderClass([[
        isSticky.value ? "stickyNav fadeInDown  dark:text-white fadeInDown dark:bg-gray-800" : "",
        _ctx.$page.url === "/" ? "" : "dark:bg-gray-800 bg-white"
      ], "flex header-wrap !z-[100] classicHeader animated"])}" data-v-e8c1cece><div class="w-full px-4 lg:px-12" data-v-e8c1cece><div class="grid items-center justify-between w-full grid-cols-12 lg:mx-auto" data-v-e8c1cece><div class="hidden logo md:col-span-2 lg:block" data-v-e8c1cece><a href="" data-v-e8c1cece><img src="/images/logo/find_02.png" class="hidden w-20 lg:block" alt="FInd" title="Find" data-v-e8c1cece></a></div><div class="col-span-3 lg:col-span-8" data-v-e8c1cece><div class="block lg:hidden" data-v-e8c1cece><button class="inline-flex items-center justify-center p-2 text-gray-700 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700 focus:text-white" x-bind:aria-label="navOpen ? &#39;Close main menu&#39; : &#39;Main menu&#39;" x-bind:aria-expanded="navOpen" data-v-e8c1cece><svg class="w-6 h-6" stroke="currentColor" fill="none" viewBox="0 0 24 24" data-v-e8c1cece><path class="${ssrRenderClass([{ "hidden": navOpen.value, "inline-flex": !navOpen.value }, "inline-flex"])}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" data-v-e8c1cece></path><path class="${ssrRenderClass([{ "hidden": !navOpen.value, "inline-flex": navOpen.value }, "hidden"])}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-e8c1cece></path></svg></button></div><nav class="relative grid__item" id="AccessibleNav" data-v-e8c1cece><ul id="siteNav" class="site-nav medium center hidearrow" data-v-e8c1cece><li class="lvl1 parent megamenu" data-v-e8c1cece>`);
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass([{ "text-white ": !isSticky.value && !isNotHome.value, "lg:hidden dark:!text-white": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece${_scopeId}>Accueil</span><span class="${ssrRenderClass([{ "hidden dark:!text-white": !isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece${_scopeId}>Accueil</span>`);
          } else {
            return [
              createVNode("span", {
      ...
      _push(`</li><li class="lvl1 parent z-[60] megamenu" data-v-e8c1cece><a href="" data-v-e8c1cece><span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece>Categories</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece>Categories</span></a><div class="megamenu z-50 dark:!bg-gray-800 !pb-12 style4 soft-scrollbar" data-v-e8c1cece><div data-v-e8c1cece>`);
      _push(ssrRenderComponent(unref(Link), {
      ...
      _push(`</div><ul class="grid grid-cols-4 dark:!text-white rounded-md grid--uniform mmWrapper" data-v-e8c1cece><!--[-->`);
      ssrRenderList(categories.value, (category) => {
        _push(`<li class="grid__item lvl-1 col-md-3 col-lg-3" data-v-e8c1cece>`);
        _push(ssrRenderComponent(unref(Link), {
        ...
        _push(`<ul class="subLinks" data-v-e8c1cece><!--[-->`);
        ssrRenderList(category.subcategories, (subcategory, index) => {
          _push(`<li class="lvl-2 dark:!text-white" data-v-e8c1cece>`);
          if (index < 4) {
            _push(ssrRenderComponent(unref(Link), {
      ...
      _push(`<!--]--></ul></div></li><li class="lvl1 parent dropdown" data-v-e8c1cece><a href="#" data-v-e8c1cece><span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:text-black lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece>Freelance</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece>Freelance</span></a><ul class="dropdown dark:!bg-gray-800" data-v-e8c1cece><li data-v-e8c1cece>`);
      _push(ssrRenderComponent(unref(Link), {
      ...
      _push(`</li></ul></li><li class="lvl1 parent dropdown" data-v-e8c1cece><a href="#" data-v-e8c1cece><span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece>Mission</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece>Mission</span></a><ul class="dropdown" data-v-e8c1cece><li data-v-e8c1cece>`);
      _push(ssrRenderComponent(unref(Link), {
      ...
      _push(`</li></ul></li><li class="lvl1 parent dropdown" data-v-e8c1cece>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("Allservices")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece${_scopeId}>Services</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece${_scopeId}>Services</span>`);
          } else {
            return [
              createVNode("span", {
      ...
      _push(`</li><li class="lvl1 parent dropdown" data-v-e8c1cece>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("home")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece${_scopeId}>A propos</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece${_scopeId}>A propos</span>`);
          } else {
            return [
              createVNode("span", {
                class: ["dark:!text-white", { "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }]
      ...
      _push(`<ul class="dropdown" data-v-e8c1cece><li data-v-e8c1cece>`);
      _push(ssrRenderComponent(unref(Link), {
      ...
      if (hoverOpen.value) {
        _push(`<div class="absolute z-50 hidden w-full h-16 mx-auto right-4 top-16" data-v-e8c1cece><div class="w-full h-24 max-w-5xl mx-auto mt-4 bg-red-300" data-v-e8c1cece></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="block col-span-6 mx-auto lg:col-span-2 lg:hidden mobile-logo" data-v-e8c1cece><div class="logo" data-v-e8c1cece>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("home")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img style="${ssrRenderStyle(!isNotHome.value ? null : { display: "none" })}" class="flex w-20 dark:hidden" src="/images/logo/find_03.png" alt="logo-find" data-v-e8c1cece${_scopeId}><img style="${ssrRenderStyle(isNotHome.value ? null : { display: "none" })}" src="/images/logo/find_02.png" alt="logo-find" class="w-24" data-v-e8c1cece${_scopeId}><img style="${ssrRenderStyle(!isNotHome.value ? null : { display: "none" })}" class="hidden w-24 dark:flex" src="/images/logo/find_02.png" alt="logo-find" data-v-e8c1cece${_scopeId}>`);
          } else {
            return [
      ...
      _push(`</div></div><div class="flex items-center justify-end col-span-3 gap-2 lg:col-span-2" data-v-e8c1cece>`);
      if (_ctx.$page.props.auth.user) {
        _push(`<div class="flex items-center gap-4" data-v-e8c1cece>`);
        _push(ssrRenderComponent(_sfc_main$3, null, null, _parent));
        _push(`<div class="hidden site-cart" data-v-e8c1cece><button type="button" class="search-trigger" data-v-e8c1cece><svg style="${ssrRenderStyle(isNotHome.value ? null : { display: "none" })}" class="${ssrRenderClass([isSticky.value ? "dark:!text-white" : "!text-white dark:!text-white", "hidden w-5 h-5 lg:block"])}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e8c1cece><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-e8c1cece></path></svg><svg style="${ssrRenderStyle(!isNotHome.value ? null : { display: "none" })}" class="hidden w-5 h-5 lg:block" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e8c1cece><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-e8c1cece></path></svg><svg class="block w-5 h-5 text-gray-700 dark:text-white lg:hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e8c1cece><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-e8c1cece></path></svg></button></div><div class="hidden lg:block" data-v-e8c1cece>`);
      ...
      if (!_ctx.$page.props.auth.user) {
        _push(`<div class="flex items-center gap-6 ml-2" data-v-e8c1cece>`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("login"),
          class: "relative items-center justify-center hidden w-full h-12 px-2 mx-auto text-base bg-transparent rounded-full lg:flex group hover:scale-105 active:duration-75 active:scale-95 sm:w-max"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="${ssrRenderClass([{ "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }, "dark:!text-white"])}" data-v-e8c1cece${_scopeId}>Connexion</span><span class="${ssrRenderClass([{ "hidden": !isNotHome.value }, "dark:!text-white text-gray-800"])}" data-v-e8c1cece${_scopeId}>Connexion</span>`);
            } else {
              return [
                createVNode("span", {
                  class: ["dark:!text-white", { "lg:text-white": !isSticky.value && !isNotHome.value, "lg:hidden": isNotHome.value && !isSticky.value, "hidden": isSticky.value && isNotHome.value }]
                ...
                createVNode("span", {
                  class: ["dark:!text-white text-gray-800", { "hidden": !isNotHome.value }]
                }, "Connexion", 2)
              ];
            }
          }),
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="relative text-base font-semibold text-white dark:text-white underline-none" data-v-e8c1cece${_scopeId}>S&#39;inscrire</span>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="relative text-base font-semibold text-amber-600" data-v-e8c1cece${_scopeId}>S&#39;inscrire</span>`);
            } else {
              return [
      ...
      ])}" class="fixed inset-0 z-[400] bg-black bg-opacity-20 lg:hidden" data-v-e8c1cece></div>`);
      if (navOpen.value) {
        _push(`<div style="${ssrRenderStyle({ "backdrop-filter": "blur(14px)", "-webkit-backdrop-filter": "blur(14px)" })}" class="fixed inset-0 bottom-0 left-0 z-[500] w-10/12 overflow-auto origin-left transform shadow-lg bg-gray-50 dark:bg-gray-800 custom-scrollbar lg:hidden" data-v-e8c1cece><div class="sticky top-0 z-20 flex justify-between h-24 p-2 bg-white border-b border-gray-700 dark:bg-gray-800 dark:border-gray-300" data-v-e8c1cece><div class="flex p-3 mx-1" data-v-e8c1cece>`);
        if (_ctx.$page.props.auth.user) {
          _push(`<div class="flex w-full text-left" data-v-e8c1cece><div class="flex-shrink-0" data-v-e8c1cece>`);
          if (_ctx.$page.props.auth.user.profile_photo_path != null) {
            _push(`<img class="w-12 h-12 rounded-full"${ssrRenderAttr("src", "/storage/" + _ctx.$page.props.auth.user.profile_photo_path)} alt="" data-v-e8c1cece>`);
          } else {
            _push(`<img class="w-16 h-16 rounded-full"${ssrRenderAttr("src", _ctx.$page.props.auth.user.profile_photo_url)} alt="" data-v-e8c1cece>`);
          }
          _push(`</div><div class="px-4 py-3" data-v-e8c1cece><span class="block text-base text-gray-800 truncate dark:text-white" data-v-e8c1cece>${ssrInterpolate(_ctx.$page.props.auth.user.name)}</span></div></div>`);
        } else {
          _push(`<div data-v-e8c1cece>`);
          _push(ssrRenderComponent(unref(Link), {
            href: _ctx.route("login"),
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="relative text-base font-semibold text-white" data-v-e8c1cece${_scopeId}>Connexion</span>`);
              } else {
                return [
        ...
        _push(`</div><div class="text-left" data-v-e8c1cece><button class="btn btn-sm btn-circle btn-outline" data-v-e8c1cece><svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e8c1cece><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-e8c1cece></path></svg></button></div></div><div class="p-4 overflow-auto custom-scrollbar" data-v-e8c1cece><div class="flex flex-col" data-v-e8c1cece><div class="flex-1 border-gray-800 dark:border-white custom-scrollbar" data-v-e8c1cece><div class="pt-4 pb-3" data-v-e8c1cece>`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("home"),
          onClick: ($event) => navOpen.value = false,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-e8c1cece${_scopeId}><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" data-v-e8c1cece${_scopeId}></path><polyline points="9 22 9 12 15 12 15 22" data-v-e8c1cece${_scopeId}></polyline></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>Accueil</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-e8c1cece${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" data-v-e8c1cece${_scopeId}></path></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>Devenir Prestataire</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(`<div class="relative" data-v-e8c1cece><button type="button" class="flex flex-row items-center w-full px-3 py-2 mt-1 text-lg font-medium text-left text-gray-800 rounded-md dark:text-gray-50 hover:dark:text-white hover:bg-gray-200 dark:hover:bg-gray-600 focus:dark:text-white focus:text-white focus:bg-amber-600" data-v-e8c1cece><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-e8c1cece><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 7.125C2.25 6.504 2.754 6 3.375 6h6c.621 0 1.125.504 1.125 1.125v3.75c0 .621-.504 1.125-1.125 1.125h-6a1.125 1.125 0 01-1.125-1.125v-3.75zM14.25 8.625c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v8.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-8.25zM3.75 16.125c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 01-1.125-1.125v-2.25z" data-v-e8c1cece></path></svg><span class="ml-2" data-v-e8c1cece>Categories</span><svg xmlns="http://www.w3.org/2000/svg" class="${ssrRenderClass([{ "rotate-180": open.value, "rotate-0": !open.value }, "w-5 h-5 px-1 mt-1 transform"])}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-e8c1cece><polyline points="6 9 12 15 18 9" data-v-e8c1cece></polyline></svg></button>`);
        _push(ssrRenderComponent(unref(Collapse), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<!--[-->`);
              ssrRenderList(categories.value, (category) => {
                _push2(`<div data-v-e8c1cece${_scopeId}><button class="flex items-center justify-between w-full px-3 py-2 mt-1 text-lg font-medium text-left text-gray-800 rounded-md dark:text-gray-50 hover:dark:text-white hover:bg-gray-200 dark:hover:bg-gray-600 focus:dark:text-white focus:text-white focus:bg-amber-600" data-v-e8c1cece${_scopeId}><span class="ml-3" data-v-e8c1cece${_scopeId}>${ssrInterpolate(category.name)}</span><svg xmlns="http://www.w3.org/2000/svg" class="${ssrRenderClass([{ "rotate-180": open.value, "rotate-0": !open.value }, "w-6 h-6 px-1 mt-1 transform"])}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-e8c1cece${_scopeId}><polyline points="6 9 12 15 18 9" data-v-e8c1cece${_scopeId}></polyline></svg></button>`);
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      ssrRenderList(category.subcategories, (subcategory) => {
                        _push3(`<div class="px-8" data-v-e8c1cece${_scopeId2}>`);
                        _push3(ssrRenderComponent(unref(Link), {
                          href: _ctx.route("SubcategoryName", [category.name, subcategory.name]),
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-e8c1cece${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M6 6.878V6a2.25 2.25 0 012.25-2.25h7.5A2.25 2.25 0 0118 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 004.5 9v.878m13.5-3A2.25 2.25 0 0119.5 9v.878m0 0a2.246 2.246 0 00-.75-.128H5.25c-.263 0-.515.045-.75.128m15 0A2.25 2.25 0 0121 12v6a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18v-6c0-.98.626-1.813 1.5-2.122" data-v-e8c1cece${_scopeId}></path></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>Services</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-e8c1cece${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607zM10.5 7.5v6m3-3h-6" data-v-e8c1cece${_scopeId}></path></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>Trouver un Freelance</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-e8c1cece${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m6.75 12l-3-3m0 0l-3 3m3-3v6m-1.5-15H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" data-v-e8c1cece${_scopeId}></path></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>Soumettre une mission</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-e8c1cece${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" data-v-e8c1cece${_scopeId}></path></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>Apropos</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-e8c1cece${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z" data-v-e8c1cece${_scopeId}></path></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>Foire aux Questions</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
        ...
        _push(`<button class="flex flex-row items-center px-3 py-2 mt-1 text-base font-medium text-gray-800 rounded-md dark:text-gray-50 hover:dark:text-white hover:bg-gray-200 dark:hover:bg-gray-600 focus:dark:text-white focus:text-white" aria-label="Toggle color mode" data-v-e8c1cece>`);
        if (!unref(isDark)) {
          _push(`<svg class="w-5 h-5 text-gray-800" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" data-v-e8c1cece><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" data-v-e8c1cece></path></svg>`);
        } else {
          _push(`<svg class="w-5 h-5 text-gray-200" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" data-v-e8c1cece><path fill-rule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clip-rule="evenodd" data-v-e8c1cece></path></svg>`);
        }
        if (!unref(isDark)) {
          _push(`<span class="ml-2 text-gray-800" data-v-e8c1cece>Sombre</span>`);
        } else {
          _push(`<span class="ml-2 text-gray-200" data-v-e8c1cece>Clair</span>`);
        }
        _push(`</button></div></div>`);
        if (_ctx.$page.props.auth.user) {
          _push(`<div class="container mt-4 border-t border-gray-800 dark:border-gray-50" data-v-e8c1cece><div class="pt-2 pb-3" data-v-e8c1cece>`);
          _push(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor" data-v-e8c1cece${_scopeId}><path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z" data-v-e8c1cece${_scopeId}></path></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>Dashboard</span>`);
              } else {
                return [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
          ...
          _push(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-e8c1cece${_scopeId}><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" data-v-e8c1cece${_scopeId}></path><circle cx="12" cy="7" r="4" data-v-e8c1cece${_scopeId}></circle></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>profile</span>`);
              } else {
                return [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
          ...
          _push(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-e8c1cece${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" data-v-e8c1cece${_scopeId}></path></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>Conversation </span>`);
              } else {
                return [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
          ...
          if (_ctx.$page.props.auth.freelance) {
            ...
            _push(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-e8c1cece${_scopeId}><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" data-v-e8c1cece${_scopeId}></path><circle cx="12" cy="7" r="4" data-v-e8c1cece${_scopeId}></circle></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>Dashboard freelance</span>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
            ...
            _push(`<a href="/freelance-gestion" class="flex flex-row items-center px-2 py-2 font-medium text-gray-800 dark:text-gray-200 text-md focus:text-gray-900 hover:text-gray-900 focus:outline-none dark:hover:bg-gray-600" role="menuitem" data-v-e8c1cece><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-e8c1cece><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" data-v-e8c1cece></path><circle cx="12" cy="7" r="4" data-v-e8c1cece></circle></svg><span class="ml-2" data-v-e8c1cece>Dashboard freelance Pro</span></a>`);
            _push(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-e8c1cece${_scopeId}><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" data-v-e8c1cece${_scopeId}></path><circle cx="12" cy="7" r="4" data-v-e8c1cece${_scopeId}></circle></svg><span class="ml-2" data-v-e8c1cece${_scopeId}>Conversation freelance</span>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
          ...
          _push(`<form data-v-e8c1cece><button type="submit" class="flex flex-row items-center px-4 py-2 text-red-500 text-md hover:text-red-700 hover:bg-red-100 focus:outline-none focus:text-red-700 focus:bg-red-100" data-v-e8c1cece><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-e8c1cece><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" data-v-e8c1cece></path><polyline points="16 17 21 12 16 7" data-v-e8c1cece></polyline><line x1="21" y1="12" x2="9" y2="12" data-v-e8c1cece></line></svg> Deconnexion </button></form></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
...
const Navbar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-e8c1cece"]]);

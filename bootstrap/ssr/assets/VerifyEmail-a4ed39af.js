...
import { A as AuthenticationCard } from "./AuthenticationCard-73fdf4da.js";
import { _ as _sfc_main$1 } from "./AuthenticationCardLogo-3664a119.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (verificationLinkSent.value) {
              _push2(`<div class="mb-4 text-sm font-medium text-green-600"${_scopeId}> A new verification link has been sent to the email address you provided in your profile settings. </div>`);
            } else {
              _push2(`<!---->`);
            }

import { ref, computed, resolveComponent, mergeProps, withCtx, openBlock, createBlock, createVNode, unref, Fragment, renderList, toDisplayString, createTextVNode, createCommentVNode, withModifiers, withDirectives, vModelText, useSSRContext } from "vue";
...
import { _ as _sfc_main$1 } from "./WebLayout-017f2aea.js";
...
import { e as cartStore } from "./userInfo-17d621bd.js";
import "@vueuse/core";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen py-2 pt-16 bg-gray-100 md:px-6 dark:bg-gray-900" }, _attrs))}><div class="hidden px-2"> All/Service </div><div class="px-4 mt-4"><nav class="flex" aria-label="Breadcrumb"><ol class="inline-flex items-center space-x-1 md:space-x-3"><li class="inline-flex items-center"><a href="#" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white"><svg class="w-3 h-3 mr-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="m19.707 9.293-2-2-7-7a1 1 0 0 0-1.414 0l-7 7-2 2a1 1 0 0 0 1.414 1.414L2 10.414V18a2 2 0 0 0 2 2h3a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h3a2 2 0 0 0 2-2v-7.586l.293.293a1 1 0 0 0 1.414-1.414Z"></path></svg> Back </a></li><li aria-current="page">`);
      ...
      _push(` Jours Delai </p><p class="flex gap-2 font-medium text-gray-700 dark:text-gray-100"><span><i class="pi pi-replay"></i></span>`);
      if (level.value === "basic") {
      ...
      _push(` Revisions </p></div><div class="flex"><button type="button" id="" class="flex items-center justify-center w-full gap-1 px-8 py-3 mt-4 text-base font-medium text-white bg-indigo-600 border border-transparent hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z"></path></svg><span>Ajouter au Panier</span></button></div></div></section></div><div class="grid w-full gap-2 p-6 bg-white rounded-lg dark:bg-gray-800">`);
      _push(ssrRenderComponent(_component_Button, {
        outlined: "",
        onClick: ($event) => contactMe.value = !contactMe.value,
        size: "small",
        label: "Contacter"
      }, null, _parent));
      _push(`</div></div></div></div><div class="w-full lg:px-4 px-2 bg-gray-50 dark:bg-gray-800 md:w-2/3"><div class="lg:p-4 dark:bg-gray-800"><div class="flex flex-col mb-4"><div><p class="mb-4 text-lg font-bold text-gray-700 md:text-xl dark:text-gray-200">${ssrInterpolate(service.value.title)}</p></div><div class="flex gap-4 mt-2"><div class="flex flex-col gap-3 my-auto"><a class="hidden text-base font-medium text-gray-500">${ssrInterpolate(service.value.freelance.nom)}</a><div class="flex flex-row gap-2"><span class="hidden text-base font-medium">Niveau ${ssrInterpolate(service.value.freelance.level)}</span>`);
      if (service.value.commandeEncours != 0) {
        _push(`<span class="text-base font-medium"><span class="text-green-600">${ssrInterpolate(service.value.commandeEncours)}</span> commande en cours </span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div><div class="mt-4"><div class="lg:w-10/12 w-full rounded-lg">`);
            ...
            ssrRenderList(props.service.data.files, (image, index) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img class="object-cover w-auto rounded-md h-auto lg:h-10/12 swiper-lazy"${ssrRenderAttr("src", "/storage/" + image)}${ssrRenderAttr("alt", image)}${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        class: "object-cover w-auto rounded-md h-auto lg:h-10/12 swiper-lazy",
                        src: "/storage/" + image,
                        alt: image
                      }, null, 8, ["src", "alt"])
                    ];
      ...
      _push(`</div></div><div class="hidden"><p class="mt-4 text-lg font-bold text-gray-800 md:text-2xl dark:text-gray-200">${ssrInterpolate(service.value.title)}</p></div><div class="mt-8">`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(TabPanel), { header: "INFO" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="py-5 min-h-64"${_scopeId2}><div class="mb-4 prose text-gray-800 md:text-base dark:text-gray-200"${_scopeId2}><div${_scopeId2}>${service.value.description}</div></div><div class="grid grid-cols-2 gap-4 mb-4"${_scopeId2}><div${_scopeId2}><p class="font-bold text-gray-500 dark:text-gray-200"${_scopeId2}>Support :</p><div id="support" class="text-gray-800"${_scopeId2}><div class="px-2 mt-2"${_scopeId2}><ul class="px-4 list-disc dark:text-gray-50"${_scopeId2}><!--[-->`);
                  ssrRenderList(service.value.basic_support, (value, index) => {
                    _push3(`<li${_scopeId2}>${ssrInterpolate(value)}</li>`);
                  });
                  _push3(`<!--]--></ul></div></div></div></div><div class="grid hidden grid-cols-2 gap-4 mb-4"${_scopeId2}><div${_scopeId2}><p class="font-bold text-gray-500 dark:text-gray-200"${_scopeId2}>Prix :</p><p class="px-2 mt-2 text-gray-700 dark:text-gray-300"${_scopeId2}>à partir de <span class="text-lg text-green-700"${_scopeId2}>${ssrInterpolate(service.value.price)}</span></p></div><div${_scopeId2}><p class="font-bold text-gray-500 dark:text-gray-200"${_scopeId2}>Délai :</p><p class="text-gray-700 dark:text-gray-300"${_scopeId2}>${ssrInterpolate(service.value.basic_delivery_time)} jours </p></div></div><div class="grid grid-cols-2 gap-4 mb-4"${_scopeId2}></div><div class="grid grid-cols-2 gap-4 mb-6"${_scopeId2}><div class="col-span-2"${_scopeId2}><p class="font-bold text-base text-gray-500 dark:text-gray-200"${_scopeId2}>Besoin pour ce service :</p><div class="prose"${_scopeId2}>${service.value.need_service}</div></div></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "py-5 min-h-64" }, [
                      ...
                      createVNode("div", { class: "grid grid-cols-2 gap-4 mb-6" }, [
                        createVNode("div", { class: "col-span-2" }, [
                          createVNode("p", { class: "font-bold text-base text-gray-500 dark:text-gray-200" }, "Besoin pour ce service :"),
                          createVNode("div", {
                            class: "prose",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (service.value.example != null) {
                    _push3(`<div class="grid grid-cols-1 gap-4"${_scopeId2}><div class="p-4 bg-white rounded-md shadow dark:bg-gray-800"${_scopeId2}><div class="flex flex-row gap-2 p-4 mb-4"${_scopeId2}>`);
                                    ...
                                    createVNode("div", { class: "p-4 mb-4 bg-gray-100 rounded-lg dark:bg-gray-600" }, [
                                      ...
                                      createVNode("div", null, [
                                        createVNode("div", { class: "flex gap-2 items-center" }, [
                                          ...
                                          createVNode("div", null, [
                                            createVNode("p", { class: "font-bold dark:text-gray-200 text-gray-800" }, "Georges")
                                          ])
                                        ])
                                      ])
                                    ])
      ...
      _push(`</div><div class="px-4 mt-6"><p class="mb-4 text-lg font-medium text-gray-800 dark:text-gray-200">À propos du freelance </p><div class="flex items-center gap-4 mb-8">`);
      ...
      _push(`<p class="block text-gray-700 truncate dark:text-gray-300">${ssrInterpolate(service.value.category.name)}</p></div></div><div class="text-base text-gray-700 dark:text-gray-100">${ssrInterpolate(service.value.freelance.description)}</div></div></div></div></div></div></div><div class="px-4 mt-4"><div class="px-4"><p class="text-lg font-bold text-gray-800 dark:text-gray-200">Du meme Categorie</p></div><div class="grid gap-4 px-4 py-4 mx-auto md:grid-cols-4"><!--[-->`);
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form class="flex flex-col justify-center flex-grow"${_scopeId}><div class="flex flex-col items-start justify-between mb-4"${_scopeId}><div class="flex items-center space-x-2"${_scopeId}><span class="text-lg font-semibold"${_scopeId}>${ssrInterpolate(service.value.user.name)}</span><span class="rounded-full h-2 w-2"${_scopeId}></span>`);
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "flex flex-col items-start justify-between mb-4" }, [
                  createVNode("div", { class: "flex items-center space-x-2" }, [
                    createVNode("span", { class: "text-lg font-semibold" }, toDisplayString(service.value.user.name), 1),
                    createVNode("span", { class: "rounded-full h-2 w-2" }),

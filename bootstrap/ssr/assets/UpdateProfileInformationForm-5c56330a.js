...
import { _ as _sfc_main$1 } from "./FormSection-e238c572.js";
        ...
        form: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (_ctx.$page.props.jetstream.hasEmailVerification && __props.user.email_verified_at === null) {
              ...
              _push2(`</p><div style="${ssrRenderStyle(verificationLinkSent.value ? null : { display: "none" })}" class="mt-2 text-sm font-medium text-green-600"${_scopeId}> Un nouveau lien a ete envoyer dans votre adresse mail. </div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="col-span-6 sm:col-span-4"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "col-span-6 sm:col-span-4" }, [
                ...
                _ctx.$page.props.jetstream.hasEmailVerification && __props.user.email_verified_at === null ? (openBlock(), createBlock("div", { key: 0 }, [
                  ...
                  withDirectives(createVNode("div", { class: "mt-2 text-sm font-medium text-green-600" }, " Un nouveau lien a ete envoyer dans votre adresse mail. ", 512), [

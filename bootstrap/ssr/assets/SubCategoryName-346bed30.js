        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class=""${_scopeId}>${ssrInterpolate(subcategory.name)}</span><div class="absolute inline-flex items-center justify-center w-4 h-4 text-[10px] font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -right-2 dark:border-gray-900"${_scopeId}>${ssrInterpolate(__props.category.service_count)}</div>`);
            } else {
              return [

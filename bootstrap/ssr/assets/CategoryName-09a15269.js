...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div class="mt-4"><h1 class="mb-4 text-lg font-bold text-gray-800">Prix</h1><div class="w-full space-y-1 dark:text-gray-100"><div class="flex flex-col gap-2 p-2"></div><div aria-hidden="true" class="flex flex-col gap-4 justify-between px-1"><span class="text-base dark:text-gray-100 mb-4"> Prix Service</span><div class="flex justify-between gap-4 p-2 border">`);

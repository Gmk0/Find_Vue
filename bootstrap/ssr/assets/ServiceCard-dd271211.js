...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="md:h-[24rem] h-52 overflow-hidden bg-white rounded-xl shadow-md dark:text-gray-200 dark:bg-gray-900"><div class="relative flex flex-row lg:flex-col"><div class="relative group w-[48%] md:w-full"><div class="p-2"><div class="h-48 transition duration-500 ease-out bg-center bg-cover border rounded-xl lg:h-44" style="${ssrRenderStyle("background-image: url(/storage/" + props.service.image[0] + ")")}"></div></div>`);

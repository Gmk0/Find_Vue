import { computed, inject, ref, onMounted, watch, resolveComponent, withCtx, createTextVNode, createVNode, toDisplayString, unref, withDirectives, vModelText, useSSRContext } from "vue";
import { ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderComponent, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
...
import { a as useCategoryStore } from "./userInfo-9512d7bb.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Template = resolveComponent("Template");
      ...
      _push(ssrRenderComponent(SectionBorder, null, null, _parent));
      _push(`<div class="mb-4 md:grid md:mb-0 md:grid-cols-3 md:gap-6"><div class="flex justify-between md:col-span-1"><div class="px-4 sm:px-0"><h3 class="text-lg font-medium text-gray-900 dark:text-gray-100"> Votre Presence Sociale </h3><p class="mt-1 text-sm text-gray-600"> Connecter vos comptes Professionnelle </p></div></div><div class="mt-5 mb-4 md:mt-0 md:col-span-2"><div class="grid grid-cols-2 gap-4 px-4"><label for="google">Google</label><button type="button"> connecter </button></div></div></div>`);
      _push(ssrRenderComponent(SectionBorder, null, null, _parent));
      ...
      if (_ctx.$page.props.auth.user.email_verified_at != null) {
        _push(`<div class="flex gap-4 italic text-gray-600"><span>Email verifier</span><span><i class="pi pi-check"></i></span></div>`);
      } else {
        _push(`<div class="flex justify-between"><span>Email non verifier</span><div>`);
      ...
      if (_ctx.$page.props.auth.user.phone_verified_at != null) {
        _push(`<div class="flex gap-4 italic text-gray-600"><span>telephone verifier</span><span><i class="pi pi-check"></i></span></div>`);
      } else {
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${_scopeId}><div class="px-4 pt-8"${_scopeId}><input type="text"${ssrRenderAttr("value", unref(code).code)} placeholder="Entrez votre texte ici" class="w-full px-3 py-2 text-gray-700 border rounded-md focus:outline-none focus:ring focus:border-blue-300"${_scopeId}>`);
            ...
            _push2(`</div></div>`);
            _push2(ssrRenderComponent(_component_Template, null, {
            ...
            return [
              createVNode("div", null, [
                createVNode("div", { class: "px-4 pt-8" }, [
                  withDirectives(createVNode("input", {
                    ...
                    class: "w-full px-3 py-2 text-gray-700 border rounded-md focus:outline-none focus:ring focus:border-blue-300"
                  }, null, 8, ["onUpdate:modelValue"]), [
                    [vModelText, unref(code).code]
                  ]),
              ...
              createVNode(_component_Template, null, {
                footer: withCtx(() => [
                  createVNode(_component_Button, {
                    label: "Fermer",
                    icon: "pi pi-times"

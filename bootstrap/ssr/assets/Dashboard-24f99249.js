...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col min-h-screen gap-6 lg:mx-auto md:p-6 md:max-w-7xl md:container px-auto dark:bg-inherit" }, _attrs))}><div class="flex flex-col"><h1 class="text-2xl font-bold">DASHBOARD</h1></div><div class="grid grid-cols-2 gap-4 px-auto lg:grid-cols-4">`);
      _push(ssrRenderComponent(_component_Link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-between"${_scopeId}><span class="text-sm font-bold text-indigo-600"${_scopeId}>Total Depense</span><span class="hidden px-2 py-1 text-xs text-gray-500 transition duration-200 bg-gray-200 rounded-lg cursor-default dark:bg-gray-500 md:flex hover:bg-gray-500 dark:text-gray-900 hover:text-gray-200"${_scopeId}>Today</span></div><div class="flex items-center justify-between mt-6"${_scopeId}><div${_scopeId}><svg class="w-8 h-8 p-1 text-indigo-600 bg-indigo-400 border border-indigo-600 rounded-full md:w-12 md:h-12 2xl:w-16 2xl:h-16 2xl:p-3 bg-opacity-20" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"${_scopeId}></path></svg></div><div class="flex flex-col"${_scopeId}><div class="flex items-end"${_scopeId}><span class="text-xl font-bold text-gray-800 dark:text-gray-100 2xl:text-3xl"${_scopeId}>${ssrInterpolate(__props.depense)}</span><div class="flex items-center hidden mb-1 ml-2"${_scopeId}><svg class="w-12 h-12 p-1 text-green-600 bg-green-400 border border-green-600 rounded-full 2xl:w-16 2xl:h-16 2xl:p-3 bg-opacity-20" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"${_scopeId}></path></svg><span class="font-bold text-sm text-gray-500 ml-0.5"${_scopeId}>2</span></div></div></div></div>`);
          } else {
            return [
              createVNode("div", { class: "flex items-center justify-between" }, [
                createVNode("span", { class: "text-sm font-bold text-indigo-600" }, "Total Depense"),
              ...
              createVNode("div", { class: "flex items-center justify-between mt-6" }, [
                ...
                createVNode("div", { class: "flex flex-col" }, [
                  createVNode("div", { class: "flex items-end" }, [
                    createVNode("span", { class: "text-xl font-bold text-gray-800 dark:text-gray-100 2xl:text-3xl" }, toDisplayString(__props.depense), 1),
                    createVNode("div", { class: "flex items-center hidden mb-1 ml-2" }, [
                      ...
                      createVNode("span", { class: "font-bold text-sm text-gray-500 ml-0.5" }, "2")
                    ])
                  ])
                ])
              ])
      ...
      _push(ssrRenderComponent(_component_Link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-between"${_scopeId}><span class="text-sm font-bold text-green-600"${_scopeId}>Commande</span><span class="hidden px-2 py-1 text-xs text-gray-500 transition duration-200 bg-gray-200 rounded-lg cursor-default dark:bg-gray-600 md:hidden dark:text-gray-900 hover:bg-gray-500 hover:text-gray-200"${_scopeId}>7 days</span></div><div class="flex items-center justify-between mt-6"${_scopeId}><div${_scopeId}><svg class="w-8 h-8 p-1 text-green-600 bg-green-400 border border-green-600 rounded-full md:w-12 md:h-12 2xl:w-16 2xl:h-16 2xl:p-3 bg-opacity-20" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"${_scopeId}></path></svg></div><div class="flex flex-col"${_scopeId}><div class="flex items-end"${_scopeId}><span class="text-2xl font-bold text-gray-800 dark:text-gray-100 2xl:text-4xl"${_scopeId}>${ssrInterpolate(__props.commandeTotal)}</span><div class="flex items-center mb-1 ml-2"${_scopeId}></div></div></div></div>`);
          } else {
            return [
              createVNode("div", { class: "flex items-center justify-between" }, [
                createVNode("span", { class: "text-sm font-bold text-green-600" }, "Commande"),
              ...
              createVNode("div", { class: "flex items-center justify-between mt-6" }, [
                ...
                createVNode("div", { class: "flex flex-col" }, [
                  createVNode("div", { class: "flex items-end" }, [
                    createVNode("span", { class: "text-2xl font-bold text-gray-800 dark:text-gray-100 2xl:text-4xl" }, toDisplayString(__props.commandeTotal), 1),
            ...
            return [
              ...
              createVNode("div", { class: "flex items-center justify-between mt-6" }, [
                ...
                createVNode("div", { class: "flex-col" }, [
                  createVNode("div", { class: "flex items-end" }, [
                    createVNode("span", { class: "text-2xl font-bold text-gray-800 dark:text-gray-100 2xl:text-4xl" }, toDisplayString(__props.transactionTotal), 1),
                    createVNode("div", { class: "items-center hidden mb-1 ml-2" }, [
                      ...
                      createVNode("span", { class: "font-bold text-sm text-gray-500 ml-0.5" }, "7%")
                    ])
                  ])
                ])
              ])
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode("div", { class: "flex items-center justify-between mt-6" }, [
                ...
                createVNode("div", { class: "flex flex-col" }, [
                  createVNode("div", { class: "flex items-end" }, [
                    createVNode("span", { class: "text-2xl font-bold text-gray-800 dark:text-gray-100 2xl:text-4xl" }, toDisplayString(__props.missionAttente), 1),
                    createVNode("div", { class: "flex items-center hidden mb-1 ml-2" }, [
                      (openBlock(), createBlock("svg", {
                      ...
                      createVNode("span", { class: "font-bold text-sm text-gray-500 ml-0.5" }, "-1%")
                    ])
                  ])
                ])
              ])
      ...
      _push(ssrRenderComponent(_component_H1, { class: "text-lg text-gray-700 dark:text-gray-200" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {

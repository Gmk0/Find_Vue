import { ref, watch, resolveComponent, mergeProps, withCtx, createTextVNode, unref, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Button, { class: "px-4 py-1.5 bg-white font-semibold text-dark" }, {
      ...
      _push(`</div></div><div class="grid gap-4 bg-white md:grid-cols-2 lg:grid-cols-3"><!--[-->`);

import { ref, computed, resolveComponent, mergeProps, unref, withCtx, openBlock, createBlock, createVNode, createTextVNode, Fragment, renderList, toDisplayString, useSSRContext } from "vue";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col w-full mt-8"${_scopeId}><div${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Textarea, {
              modelValue: unref(form).description,
              "onUpdate:modelValue": ($event) => unref(form).description = $event,
              class: "w-full"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="flex gap-4 mt-4"${_scopeId}>`);

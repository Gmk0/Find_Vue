import { withCtx, createVNode, openBlock, createBlock, unref, createCommentVNode, withModifiers, useSSRContext } from "vue";
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="flex"${_scopeId2}><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"${_scopeId2}><path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z"${_scopeId2}></path></svg><span class="ml-2"${_scopeId2}> Tableau utilisateur</span></span>`);
                } else {
                  return [
                    createVNode("span", { class: "flex" }, [
                      (openBlock(), createBlock("svg", {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (unref(isDark)) {
                    _push3(`<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"${_scopeId2}></path></svg>`);
                  } else {
            ...
            return [
              ...
              _ctx.$page.props.auth.freelance ? (openBlock(), createBlock(_sfc_main$2, {
                key: 0,
                href: _ctx.route("freelance.dashboard")
              }, {
                default: withCtx(() => [

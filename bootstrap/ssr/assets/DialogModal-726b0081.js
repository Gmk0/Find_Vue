...
import { S as SectionTitle } from "./SectionTitle-1fb44ea7.js";
const _sfc_main$2 = {
  __name: "ActionSection",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "md:grid md:gap-6" }, _attrs))}>`);
      ...
      _push(`<div class="mt-5 md:mt-0 md:col-span-2"><div class="px-4 py-5 bg-white shadow dark:bg-gray-900 sm:p-6 sm:rounded-lg">`);
      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderSlot(_ctx.$slots, "title", {}, null, _push2, _parent2, _scopeId);
            _push2(`</div><div class="mt-4 text-sm text-gray-600 dark:text-gray-300"${_scopeId}>`);
            ssrRenderSlot(_ctx.$slots, "content", {}, null, _push2, _parent2, _scopeId);
            _push2(`</div></div><div class="flex flex-row justify-end px-6 py-4 bg-gray-100 dark:bg-gray-900 text-right"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "px-6 py-4" }, [
                ...
                createVNode("div", { class: "mt-4 text-sm text-gray-600 dark:text-gray-300" }, [

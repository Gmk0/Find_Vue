import { computed, mergeProps, useSSRContext, ref, onMounted, watch, resolveComponent, resolveDirective, unref, withCtx, createTextVNode, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, withDirectives } from "vue";
import { ssrRenderAttrs, ssrIncludeBooleanAttr, ssrLooseContain, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrGetDirectiveProps, ssrRenderAttr } from "vue/server-renderer";
import { _ as _sfc_main$4 } from "./UserLayout-2ac5c552.js";
import "./DeleteUserForm-b63329d2.js";
import _sfc_main$8 from "./LogoutOtherBrowserSessionsForm-b50679b4.js";
import { S as SectionBorder } from "./SectionBorder-50fdc36f.js";
import _sfc_main$7 from "./TwoFactorAuthenticationForm-400d1150.js";
import _sfc_main$6 from "./UpdatePasswordForm-acb4905f.js";
import _sfc_main$5 from "./UpdateProfileInformationForm-5c56330a.js";
import { c as useNotification, d as useParrainage } from "./userInfo-b7520541.js";
import "@inertiajs/vue3";
import axios from "axios";
import { _ as _sfc_main$3 } from "./TextInput-14bc0530.js";
import "./FormSection-e238c572.js";
...
import "@vueuse/core";
import "./DialogModal-726b0081.js";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "md:grid md:grid-cols-1 md:gap-6" }, _attrs))}><div class="flex justify-between md:col-span-1"><div class="px-4 sm:px-0"><h3 class="text-lg font-medium text-gray-900 dark:text-gray-50"> Boostez vos Avantages avec le Parrainage! </h3><p class="mt-1 text-sm text-gray-600 dark:text-gray-100"><span class="dark:text-gray-50">Mettez à jour votre profil et votre adresse e-mail pour débloquer des avantages exclusifs grâce à notre programme de parrainage. Invitez vos amis à rejoindre et profitez ensemble des opportunités exceptionnelles qui vous attendent!</span></p></div></div><div class="mt-5 rounded-md md:mt-0 md:col-span-2"><div><div class="px-4 py-5 bg-white shadow dark:bg-gray-900 sm:p-6"><div class="">`);
      if (!skeleton.value) {
        _push(`<div class="mb-6">`);
        if (codeParainage.value != null) {
          _push(`<h2 class="mb-2 text-2xl font-bold dark:text-gray-100">Votre code Parainage : <span class="dark:text-gray-50">${ssrInterpolate(codeParainage.value)}</span></h2>`);
        } else {
      ...
      if (skeleton.value) {
        ...
        if (utilisateurParainer.value.length > 0) {
          ...
          if (!_ctx.$page.props.auth.user.gift_used) {
            _push(`<div>`);
            if (utilisateurParainer.value.length >= 1) {
              _push(`<div class="mt-4"><p class="text-lg text-amber-500 mb-4">Félicitations! Vous avez parrainé 10 utilisateurs et vous avez gagné un cadeau spécial! 🥳​🥳​</p>`);
              _push(ssrRenderComponent(_component_Link, { class: "mt-6 text-lg text-green-500" }, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_Button, mergeProps({
              ...
              size: "small",
              outlined: ""
            }, ssrGetDirectiveProps(_ctx, _directive_clipboard, link.value, "copy"), ssrGetDirectiveProps(_ctx, _directive_clipboard, onCopy, "success"), ssrGetDirectiveProps(_ctx, _directive_clipboard, onError, "error")), null, _parent2, _scopeId));
            _push2(`</div></div></div>`);
          } else {
            return [
                ...
                createVNode("div", { class: "flex gap-2 mt-4" }, [
                  ...
                  createVNode("div", { class: "w-[20%]" }, [
                    withDirectives(createVNode(_component_Button, {
                      ...
                      [_directive_clipboard, link.value, "copy"],
